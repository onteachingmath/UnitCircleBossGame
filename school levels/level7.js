...
function runLevel7(player, handleResult) {
  ...
  { questionLatex: '\\arcsin\\left(-\\frac{1}{2}\\right)', choices: ['-30^\\circ', '30^\\circ', '-150^\\circ', '60^\\circ'], correctIndex: 0, topic: 'inverse-trig' },
  ...
  { questionLatex: '\\arcsin\\left(-\\frac{\\sqrt{2}}{2}\\right)', choices: ['-45^\\circ', '45^\\circ', '-135^\\circ', '-60^\\circ'], correctIndex: 0, topic: 'inverse-trig' },
  ...
  { questionLatex: '\\arctan(-1)', choices: ['-45^\\circ', '45^\\circ', '-135^\\circ', '135^\\circ'], correctIndex: 0, topic: 'inverse-trig' }
];
  ...
  function showFinalResults() {
    ...
    let resultHTML = `
      <div class="level-header">
        <h2>🎯 Final Score: ${correctCount} / 10</h2>
    `;
